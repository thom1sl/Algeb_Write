...
def main():
    ...
    img_erase_bouton_on = pygame.image.load("images/erase_on.png")
    img_submit_bouton = pygame.image.load("images/submit.png")
    img_submit_bouton_on = pygame.image.load("images/submit_on.png")
    ...
    text_calcul_secondaire = font100.render(
        calcul_secondaire, True, dark_blue)
                    ...
                    if event.button == 1:
                        ...
                        if leftarrow2.collidepoint(pos):
                            index_parametre_du_mode_de_jeu = (
                                index_parametre_du_mode_de_jeu-1) % 3
                            text2 = font30.render(
                                dico[mode_de_jeu][1][index_parametre_du_mode_de_jeu][1], True, white)
                        if rightarrow2.collidepoint(pos):
                            index_parametre_du_mode_de_jeu = (
                        ...
                        # sinon -> on lis les zones
                            ...
                            if b:
                                ...
                                if len(lisibl) == 1:
                                    ...
                                    text3 = font45.render(lisibl, True,  white)
                            else:
                                lisibl += ''
